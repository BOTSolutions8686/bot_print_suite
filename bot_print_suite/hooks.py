...
# for Sales Order.
app_include_js = ["/assets/bot_print_suite/js/sales_order.js?v=20260924-operating-account"]
...
doc_events = {
	...
	"Stock Entry": {
		"before_validate": "bot_print_suite.utils.set_print_job_operating_cost_account",
	},
	"Job Card": {
